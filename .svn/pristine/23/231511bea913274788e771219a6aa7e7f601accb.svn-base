...
<form method="post" action="editStage.html">
		...
		<table>
			<tr>
				...
				<td>
					<input class="textadd" type="text" name="SName" value="${stage.SName }"/>
				</td>
			</tr>
			<tr>
			<td></td>
				<td><input type="hidden" name="planid" value="${planid}">
				<input type="hidden" name="sid" value="${stage.sid}">
